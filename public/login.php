...
<body id="fondo" style="background-image: url('img/Salvando.png')">
    ...
    <form id="form1" method="post"> 
        ...
        <div class="submit-container">
            <input style="background-color: #371349;color:white;padding: 10px 15px;margin: 8px 0;
            cursor: pointer;width: 75%;border-radius: 30px;border: none;"
            onmouseover="this.style.backgroundColor='#371349'; this.style.opacity='0.8';"
            onmouseout="this.style.backgroundColor='#371349'; this.style.opacity='1';"
